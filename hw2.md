...
The file contains all of the integers between 1 and 10,000 (inclusive, with no repears) in unsorted order. The integer in the ith row of the file gives you the ith entry of an input array.
